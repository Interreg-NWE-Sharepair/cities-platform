...
return [
    'account/set-password' => ['template' => '_account/_password-set'],
    'account/password-set-successfully' => ['template' => '_account/_password-set-confirmation'],
    'repair-heroes/<uid:{uid}>' => ["template" => "_repair-hero/_entry"],
    'organisations/<uid:{uid}>' => 'statik/organisations/redirect',
];
